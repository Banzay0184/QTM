...
const Hero = () => {
  ...
  // Массив изображений
  const images = [
    "https://www.gazeta.uz/media/img/2022/01/DhxJJ316424213436263_b.jpg", // Студент с книгами
    "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80", // Университетская аудитория
    "https://travelstudy.uz/thumb/2/j3h7u37qaFBALXNAO0fLGg/3000r3000/d/54908428_2.jpg", // Студент за партой
  ]
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center relative overflow-hidden pt-20 bg-gradient-to-b from-primary/90 to-primary/70">
      <div className="container mx-auto px-4 z-10 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-white">
          ...
          >
            Biz o‘quvchilarni davlat oliy o‘quv yurtlariga muvaffaqiyatli kirishga tayyorlaymiz — kelajagingiz uchun birinchi qadam.
          </motion.p>
      ...
      >
        <a href="#statistics" className="text-white/90 flex flex-col items-center" aria-label="Statistikaga o‘tish">
